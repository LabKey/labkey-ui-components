...
describe('FilterValueDisplay', () => {
    ...
    test('relative date filter: negative', () => {
        const wrapper = mount(<FilterValueDisplay filter={Filter.create('DateField', '-1d', Filter.Types.Equals)} jsonType="date" />);
    ...
    test('relative date filter: positive', () => {
        const wrapper = mount(<FilterValueDisplay filter={Filter.create('DateField', '+3d', Filter.Types.Equals)} jsonType="date" />);
