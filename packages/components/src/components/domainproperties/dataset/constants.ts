...
export const DATASET_CATEGORY_TIP = "Assigning a category to a dataset will group it with similar datasets in the navigator and data browser.";

export const DATASET_LABEL_TIP = "The name of the dataset shown to users. If no Label is provided, the Name is used.";

export const DATASET_ID_TIP = "The unique, numerical identifier for your dataset. It is defined during dataset creation and cannot be modified.";

export const VISIT_DATE_TIP = "If the official 'Visit Date' for a visit can come from this dataset, choose the date column to represent it. Note that since datasets can include data from many visits, each visit must also indicate the official 'VisitDate' dataset.";
