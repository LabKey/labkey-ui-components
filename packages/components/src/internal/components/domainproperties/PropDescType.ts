...
import {
    ATTACHMENT_RANGE_URI, BINARY_RANGE_URI, BOOLEAN_RANGE_URI, DATE_RANGE_URI, DATETIME_RANGE_URI,
    DECIMAL_RANGE_URI,
    DOUBLE_RANGE_URI, FILELINK_RANGE_URI, FLAG_CONCEPT_URI, FLOAT_RANGE_URI,
    INT_RANGE_URI, LONG_RANGE_URI, MULTILINE_RANGE_URI, PARTICIPANTID_CONCEPT_URI,
    SAMPLE_TYPE_CONCEPT_URI, STRING_RANGE_URI, TIME_RANGE_URI,
    USER_RANGE_URI,
} from './constants';
