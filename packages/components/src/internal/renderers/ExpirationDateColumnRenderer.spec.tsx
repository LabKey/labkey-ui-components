...
describe('ExpirationDateColumnRenderer', () => {
    function validate(
        ...
        if (hasTd) {
            ...
            expect(wrapper.find('.expired-form-field')).toHaveLength(hasExpired ? 1 : 0);

        if (!displayValue)
            expect(wrapper.text()).toEqual("");
        else
            expect(wrapper.text()).toBe(displayValue);
    }
    ...
    test('has formattedValue and has displayValue', () => {
        const data = fromJS({value: '2022-02-12 11:58:54.385', formattedValue: '2022-02-12', displayValue: '2022-02-12 11:58' });
    ...
    test('has formattedValue and has displayValue - not immutable map', () => {
        const data = {value: '2022-02-12 11:58:54.385', formattedValue: '2022-02-12', displayValue: '2022-02-12 11:58' };
        const wrapper = mount(<ExpirationDateColumnRenderer data={data} />);
        validate(wrapper, true, '2022-02-12');
        wrapper.unmount();
    });
