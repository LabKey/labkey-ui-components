...
describe('DomainRow', () => {
    ...
    // FIXME: this test suite is disabled because it results in react-beautiful-dnd components being rendered. We can
    //  re-enable these test cases when:
    //  1. We replace react-beautiful-dnd
    //  2. We have something specific to test for, do not re-enable with any snapshot tests
    test('FIXME', () => {});
