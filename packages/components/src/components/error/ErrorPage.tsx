                ...
                <div className="container">
                    <Page hasHeader={true} title={title}>
                        ...
                        <div className="alert alert-danger" role="alert">
                            An unexpected error caused the application to stop working.
                            Please refresh the page. If the problem persists contact support.
                        </div>
                        <div className="panel panel-default">
                            <div className="panel-body">
                                <dl className="dl-horizontal dl-error-page-details">
                                    <dt>Error</dt><dd>{`${error.name}: ${error.message}`}</dd>
                                    <dt>URL</dt><dd>{window.location.href}</dd>
                                    <dt>Developer Mode</dt><dd>{devMode ? 'Yes' : 'No'}</dd>

                                    <dt>Logging Enabled</dt>
                                    <dd>{this.isFeatureEnabled(ExperimentalFeatures.javascriptErrorServerLogging) ? 'Yes' : 'No'}</dd>
