...
describe('AdministrationSubNav', () => {
    test('getAdministrationSubNavTabs', () => {
        ...
        expect(getAdministrationSubNavTabs(TEST_USER_FOLDER_ADMIN).size).toBe(3);
        expect(getAdministrationSubNavTabs(TEST_USER_PROJECT_ADMIN).size).toBe(3);
        expect(getAdministrationSubNavTabs(TEST_USER_APP_ADMIN).size).toBe(3);
    });
});
