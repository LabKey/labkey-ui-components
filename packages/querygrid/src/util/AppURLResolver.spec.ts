...
// import {URLResolver} from '@glass/querygrid'
...
//     });
//
//     test('Should resolve /rd/expdata routes', () => {
//
//         const routes = Map<number, List<string>>().asMutable();
//         routes.set(42, List(['media', 'Jackie']));
//         routes.set(24, List(['registry', 'griFFey']));
//         routes.set(11, List(['other', 'EDGAR']));
//         const expDataResolver = new ExpDataResolver(routes.asImmutable());
//
//         // test regex
//         expect.assertions(9);
//         expect(expDataResolver.matches(undefined)).toBe(false);
//         expect(expDataResolver.matches('/rd/expdata/2f4')).toBe(false);
//         expect(expDataResolver.matches('/rd/expdata/24')).toBe(true);
//         expect(expDataResolver.matches('/rd/expdata/919/foo/bar')).toBe(true);
//         expect(expDataResolver.matches('/rd/expdata/919/foo/bar?bar=1')).toBe(true);
//
//         return Promise.all([
//             expDataResolver.fetch(['rd', 'expdata', 'boom']).then((result: boolean) => {
//                 expect(result).toBe(true);
//             }),
//             expDataResolver.fetch(['rd', 'expdata', '42']).then((url: AppURL) => {
//                 expect(url.toString()).toBe('/media/jackie/42');
//             }),
//             expDataResolver.fetch(['rd', 'expdata', 24, 'homerun']).then((url: AppURL) => {
//                 expect(url.toString()).toBe('/registry/griffey/24/homerun');
//             }),
//             expDataResolver.fetch(['rd', 'expdata', '11', 11, '?']).then((url: AppURL) => {
//                 expect(url.toString()).toBe('/other/edgar/11/11/%3f');
//             })
//         ]);
//     });
//
//     test('Should resolve /rd/dataclass routes', () => {
//
//         const routes = Map<string, string>().asMutable();
//         routes.set('jordan', 'media');
//         routes.set('kobe', 'registry');
//         routes.set('pistolpete', 'foobar');
//         const expDataResolver = new DataClassResolver(routes.asImmutable());
//
//         // test regex
//         expect.assertions(8);
//         expect(expDataResolver.matches(undefined)).toBe(false);
//         expect(expDataResolver.matches('/rd/dataclass/2f4')).toBe(true);
//         expect(expDataResolver.matches('/rd/dataclass/xwing/foo/bar')).toBe(true);
//         expect(expDataResolver.matches('/rd/dataclass/ywing/foo/bar?bar=1')).toBe(true);
//
//         return Promise.all([
//             expDataResolver.fetch(['rd', 'dataclass', 'boom']).then((result: boolean) => {
//                 expect(result).toBe(true);
//             }),
//             expDataResolver.fetch(['rd', 'dataclass', 'jordan']).then((url: AppURL) => {
//                 expect(url.toString()).toBe('/media/jordan');
//             }),
//             expDataResolver.fetch(['rd', 'dataclass', 'kobe', 13, 15]).then((url: AppURL) => {
//                 expect(url.toString()).toBe('/registry/kobe/13/15');
//             }),
//             expDataResolver.fetch(['rd', 'dataclass', 'pistolpete', 11, '11', '?']).then((url: AppURL) => {
//                 expect(url.toString()).toBe('/foobar/pistolpete/11/11/%3f');
//             })
//         ]);
//     });
//
