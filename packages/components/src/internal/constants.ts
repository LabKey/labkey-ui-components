...
export const LKB_PIPELINE_JOB_NOTIFICATION_EVENT =
    'org.labkey.biologics.notification.BiologicsPipelineJobNotificationProvider.ImportNotify';
export const LKB_PIPELINE_JOB_NOTIFICATION_EVENT_START = LKB_PIPELINE_JOB_NOTIFICATION_EVENT + '#Start';
export const LKB_PIPELINE_JOB_NOTIFICATION_EVENT_SUCCESS = LKB_PIPELINE_JOB_NOTIFICATION_EVENT + '#Success';
export const LKB_PIPELINE_JOB_NOTIFICATION_EVENT_ERROR = LKB_PIPELINE_JOB_NOTIFICATION_EVENT + '#Error';
