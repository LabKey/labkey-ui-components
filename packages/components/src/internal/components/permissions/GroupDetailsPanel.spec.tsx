...
describe('<GroupDetailsPanel/>', () => {
    test('no principal', () => {
        const component = <GroupDetailsPanel principal={undefined} policy={POLICY} rolesByUniqueName={ROLES_BY_NAME} members={[]} />;
    ...
    test('with principal', () => {
        const component = <GroupDetailsPanel principal={GROUP} policy={POLICY} rolesByUniqueName={ROLES_BY_NAME} members={[]} />;
