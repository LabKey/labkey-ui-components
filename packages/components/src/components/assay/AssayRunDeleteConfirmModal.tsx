    ...
    render() {
        ...
        return (
            <ConfirmModal
                ...
                msg={
                    <span>
                        The entirety of the {numToDelete > 1 ? numToDelete : ''} selected {noun} and any of {numToDelete === 1 ? 'its' : 'their'} previously replaced versions will be permanently deleted.&nbsp;
