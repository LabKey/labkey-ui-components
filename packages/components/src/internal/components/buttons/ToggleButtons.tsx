    ...
    return (
        <>
            ...
            <div
                ...
                id={id}
            >
                <button className={firstCls} disabled={disabled} onClick={firstBtnClick} type="button">
                    {first}
                </button>
                <button className={secondCls} disabled={disabled} onClick={secondBtnClick} type="button">
                    {second}
                </button>
            </div>
        </>
