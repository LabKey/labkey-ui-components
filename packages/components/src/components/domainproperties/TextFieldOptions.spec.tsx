...
describe('TextFieldOptions', () => {
    test('Text data type', () => {
        ...
        let textField = mount(<TextFieldOptions {...props} />);
        ...
        const maxLength = textField
            .find({ id: createFormInputId(DOMAIN_FIELD_MAX_LENGTH, 1, 1) })
        ...
        const customLength = textField
            .find({ id: createFormInputId(DOMAIN_FIELD_CUSTOM_LENGTH, 1, 1) })
            .not({ bsClass: 'form-control' });
        ...
        // Custom value
        const lengthField = textField.find({
