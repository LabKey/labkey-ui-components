...
export class RegexValidationOptions extends React.PureComponent<RegexValidationOptionsProps, any> {
    ...
    renderCollapsed = () => {
        ...
        return(
            <div>{(validator.name ? validator.name : 'Regex Validator') + ': ' + (validator.expression ? validator.expression : 'Missing expression') }
    ...
    regExTooltip = () => {
        return ("The regular expression that this field's value will be evaluated against. All regular expressions must be " +
