...
export class SampleTypeDesignerImpl extends React.PureComponent<InjectedBaseDomainDesignerProps & Props, State> {
    ...
    onFinish = (comment?: string): void => {
        ...
        const isValid = model.isValid(defaultSampleFieldConfig, metricUnitProps?.includeMetricUnitProperty);
        ...
        } else if (!model.isMetricUnitValid(metricUnitProps?.includeMetricUnitProperty)) {
