...
import {
    ...
    isSamplesSchema,
    LoadingSpinner,
    OperationConfirmationData, QueryInfo,
...
describe('getSampleTypeTemplateUrl', () => {
    ...
    test('with importAliases', () => {
        const qInfo = QueryInfo.fromJSON({ schemaName: 'schema', name: 'query', columns: {} });
        expect(getSampleTypeTemplateUrl(qInfo, {a: '1', b: '2'}).indexOf('&includeColumn=a&includeColumn=b') > -1).toBeTruthy();
    });
