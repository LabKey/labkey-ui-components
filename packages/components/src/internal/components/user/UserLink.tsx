...
export const UserLink: FC<UserLinkProps> = props => {
    ...
    if (!isSelf && (!userCanReadUserDetails(user) || !targetUserDisplayValue)) {
        ...
        if (!user.isSystemAdmin) {
            title = 'User may have been deleted from the system or no longer have permissions within this folder.';
        }
    ...
    return (
        <>
            <button className="clickable-text user-link" onClick={toggleDetailsModal} type="button">
