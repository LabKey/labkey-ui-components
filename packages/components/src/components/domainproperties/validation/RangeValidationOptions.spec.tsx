...
describe('RangeValidationOptions', () => {
    ...
    test('Range Validator - expanded', () => {
        ...
        const validator  = mount(<RangeValidationOptions
            {...props}
        />);
    ...
    test('Range Validator - collapsed', () => {
        ...
        expect(collapsed.children().children().text()).toEqual("Test range validator: Is Greater Than 0 and Is Less Than 10");
