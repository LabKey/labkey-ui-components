...
describe('getFilterLabKeySql', () => {
    ...
    test('not startsWith, flip negate', () => {
        expect(
            getFilterLabKeySql(Filter.create('StringField', 'ABC', Filter.Types.DOES_NOT_START_WITH), 'string', null, true)
    ...
    test('neq OR null, flip negate', () => {
        expect(getFilterLabKeySql(Filter.create('StringField', 'ABC', Filter.Types.NEQ_OR_NULL), 'string', null, true)).toEqual(
            "\"StringField\" = 'ABC'"
        );
    });
    ...
    test('value list, string, exclusion, flip negate', () => {
        expect(
            ...
            "(\"StringField\" IN ('value1', 'value2', 'value3', 'value4', 'value5', 'value6', 'value7'))"
        );
    });
    ...
    test('value list, float, exclusion, flip negate', () => {
        expect(getFilterLabKeySql(Filter.create('FloatField', '1.1;2.2;3.3', Filter.Types.NOT_IN), 'float', null, true)).toEqual(
            "(\"FloatField\" IN (1.1, 2.2, 3.3))"
        );
    });
    ...
    test('not between, int, flip negate', () => {
        expect(getFilterLabKeySql(Filter.create('IntField', '1,100', Filter.Types.NOT_BETWEEN), 'int', null, true)).toEqual(
            "\"IntField\" BETWEEN 1 AND 100"
        );
    });
